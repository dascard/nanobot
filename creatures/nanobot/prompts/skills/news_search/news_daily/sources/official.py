...
DEFAULT_SOURCES: list[SourceConfig] = [
    ...
    SourceConfig(name="deepseek_news", type="html_list",
                 ...
                 trust=0.92, weight=1.0, group="core_provider", enabled=False,
    ...
    SourceConfig(name="kimi_blog", type="html_list",
                 ...
                 trust=0.88, weight=1.0, group="core_provider", enabled=False,
                 category_hint=["Kimi", "模型"]),
    SourceConfig(name="xai_news", type="html_list",
                 url="https://x.ai/news",
                 trust=0.90, weight=1.0, group="core_provider", enabled=False,
