...
from api.admin.eval_routes import (
    ...
    EvalReplayCompareRequest as EvalReplayCompareRequest,
    EvalReplayFaultMatrixRequest as EvalReplayFaultMatrixRequest,
    ...
    eval_replay_compare as eval_replay_compare,
    eval_replay_fault_matrix as eval_replay_fault_matrix,
...
from api.admin.skill_candidate_routes import router as skill_candidate_router
from api.admin.mcp_routes import router as mcp_router
...
router.include_router(skill_candidate_router)
