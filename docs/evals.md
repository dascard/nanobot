...
P4-4 已为 RAG benchmark 增加专用 baseline diff 和 gate。P4-5G 后，稳定门禁运行 manual case、固定 fixture positive cases 和 deterministic provider：
