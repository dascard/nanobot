...
- **下一步**：路线项 8 / P4 已完成通用 `candidates → labeled` 标注闭环、Admin 契约化工作台和 P4-3 per-capability 数据集扩展。下一阶段推进 P4-4 RAG 标注闭环与 RAG baseline gate。
