...
- [ ] **超大文件 >800 行拆分** · MEDIUM · L
  `admin_routes.py`(4303)、`routes.py`(2822)。按职责拆模块；`news_search/tool.py` 已从原 1835 行拆至 798 行，`group_runtime/runtime.py` 已从原 1385 行拆至 722 行，`core/persona_preprocess.py` 已从原 857 行拆至 773 行，三者不再属于当前 >800 行清单。
