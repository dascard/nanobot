...
- **下一步**：路线项 8 / P4 已完成通用 `candidates → labeled` 标注闭环、Admin 契约化工作台、P4-3 per-capability 数据集扩展和 P4-4 RAG baseline gate。下一阶段推进 P4-5 更多 suite PR gate、周期性复跑和 RAG manual 样本扩充。
