...
| P2-2 | 进行中，任务 1-4 已完成 | 标准化请求 / 响应信封 | 设计已随 `c984036` 提交，实现计划已写入 `.Codex/plans/message-envelope.md`；共享 builder、`/chat` 非流式、SSE done、`/group/message` 和定时任务 push 已接入兼容信封，后续继续 route push / 文档收口 | `c984036` / `147421b` / `57006f3` / `49b3104` / `feat(推送): 支持信封推送适配` |
