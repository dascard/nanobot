...
| P4-5B | 下一步 | 周期性复跑与报告归档 | 在统一 PR gate 基础上增加定期复跑、报告产物和失败处理说明 | 待设计 |
| P4-5C | 下一步 | RAG manual 样本扩充 | 扩充人工确认的 RAG manual case，并按 gate 结果更新稳定 baseline | 待设计 |
