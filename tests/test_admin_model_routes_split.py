...
_ADMIN_MODEL_ROUTE_SIGNATURES = (
    ...
    ("DELETE", "/api/v1/admin/models/providers/{provider_id}"),
    ("POST", "/api/v1/admin/models/providers/{provider_id}/test"),
    ("POST", "/api/v1/admin/models/providers/{provider_id}/catalog/refresh"),
...
_MODEL_ROUTE_EXPORTS = (
    ...
    "test_model_provider",
    "refresh_model_provider_catalog",
