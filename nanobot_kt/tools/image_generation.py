"""图片生成工具的 KT/new-api Provider Adapter。"""
...
from app.tool_services.image_generation import (
    ALLOWED_IMAGE_BACKGROUNDS as _ALLOWED_BACKGROUNDS,
    ALLOWED_IMAGE_QUALITIES as _ALLOWED_QUALITIES,
    ALLOWED_IMAGE_SIZES as _ALLOWED_SIZES,
    execute_image_generation,
    normalize_image_option as _normalize_option,
)
from config import (
...
__all__ = [
    "ImageGenerationTool",
    "_extract_any_stream_image_b64",
    "_extract_image_b64",
    "_extract_response_completed_image_b64",
    "_iter_sse_objects",
    "_normalize_option",
]
