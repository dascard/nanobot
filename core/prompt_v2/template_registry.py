...
_LEGACY_ALIASES = MappingProxyType({
    ...
    "sandbox_poll": "tools/sandbox_poll/usage",
    "sandbox_write_stdin": "tools/sandbox_write_stdin/usage",
    "sandbox_terminate": "tools/sandbox_terminate/usage",
    ...
    "news_daily_quality": "tasks/news_daily_quality",
    "news_relevance_review": "tasks/news_relevance_review",
    "group_analysis_topics_task": "tasks/group_analysis_topics",
    "group_analysis_titles_task": "tasks/group_analysis_titles",
    "group_analysis_quotes_task": "tasks/group_analysis_quotes",
    "group_analysis_quality_task": "tasks/group_analysis_quality",
    "group_memory_learning": "tasks/group_memory_learning",
...
_TASK_TOOL_NAMES = MappingProxyType({
    ...
    "tasks/news_relevance_review": "news_relevance_review",
    "tasks/group_analysis_topics": "group_analysis_topics",
    "tasks/group_analysis_titles": "group_analysis_titles",
    "tasks/group_analysis_quotes": "group_analysis_quotes",
    "tasks/group_analysis_quality": "group_analysis_quality",
    "tasks/group_memory_learning": "group_memory_learning",
