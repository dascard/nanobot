...
def build_runtime_event_registry() -> RuntimeEventRegistry:
    descriptors = (
        ...
        RuntimeEventDescriptor(
            name="mcp.call",
            domain="mcp",
            owner_module="mcp.runtime",
            phases=("started", "succeeded", "failed"),
            fields=(
                _field("server_id", "identifier", required=True),
                _field("tool_name", "identifier", required=True),
                _field("input_schema_sha256", "digest", required=True),
                _field("latency_ms", "duration_ms"),
                _field("is_error", "boolean"),
                _field("retryable", "boolean"),
        ...
        RuntimeEventDescriptor(
            ...
            domain="subagent",
            owner_module="agent.orchestration",
            phases=("started", "succeeded", "failed"),
            fields=(
                _field("child_run_id", "identifier", required=True, max_chars=192),
                _field("task_id", "identifier", required=True),
                _field("role_id", "identifier", required=True),
                _field("attempt_no", "count", required=True),
                _field("model", "identifier", required=True, max_chars=192),
                _field("status", "label"),
                _field("latency_ms", "duration_ms"),
                _field("model_call_count", "count"),
                _field("tool_call_count", "count"),
                _field("artifact_count", "count"),
                _field("input_tokens", "count"),
                _field("output_tokens", "count"),
                _field("cached_input_tokens", "count"),
                _field("reasoning_tokens", "count"),
                _field("cost_microunits", "count"),
                _field("retryable", "boolean"),
                _field("failure_code", "label"),
                _field("error_type", "label"),
            ),
